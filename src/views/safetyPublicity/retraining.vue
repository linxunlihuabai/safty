  ...
  <div class="app-container">
    <div class="panel">
      ...
      <el-dialog
        ...
        width="550px"
        :label-width="GLOBAL.DIALOG_WIDTH_ZH.SMALL"
  ...
  methods: {
    removeDomain(item) {
      ...
      if (this.domains.length > 1) {
        ...
        this.$message.error('这是最后一个内容啦！不能再删了')
      }
    },
    addDomain(item) {
      console.log(item)
    ...
    dailyCulturalConstructionFormSubmit() {
      this.$refs.dailyCulturalConstructionForm.validate((valid) => {
        ...
        if (this.dailyCulturalConstructionForm.retrainingList === [] || this.dailyCulturalConstructionForm.retrainingList === '' || this.dailyCulturalConstructionForm.retrainingList === null) {
          this.$message.error('请输入复训名单内容')
        }
        if (valid) {
