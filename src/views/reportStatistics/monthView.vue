    ...
    <div class="panel">
      ...
      <el-tabs v-model="activeName">
        ...
        >
          ...
          <tips-card v-if="item==activeName" ref="tipsCard" :type="form.type" />
  ...
  watch: {
    $route: {
      handler(val) {
        ...
        activeName = (activeName === ':activeName' ? '安全生产综合表' : this.$route.params.activeName)
    ...
    fetchList(type, cpage, pageSize) {
      ...
      getreportList(params)
        .then(res => {
          ...
          // 调用子组件方法(是循环的)
          this.$refs.tipsCard[0].fetchList()
        })
        .catch(() => {})
    },
